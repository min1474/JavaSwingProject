...
public class AdminPrintSearchFrame2 extends JFrame {
	...
	public AdminPrintSearchFrame2() {
		...
		bookingButton.setBounds(572, 396, 191, 51);
		...
		JLabel noticeLabel = new JLabel("회원일 경우 마이페이지에서 예약해주세요. 비회원은 이름과 연락처만 입력 후 예약 가능합니다");
		...
		JButton searchBookingButton = new JButton("예약조회");
...
//				new SearchBookingInfoNonMember(dtoB);
		...
		searchBookingButton.setBounds(798, 396, 141, 51);
