...
public class MenuPanel4PizzaSalad extends JPanel {
	
	private MenuFrame mFrame;
	
	
	public MenuPanel4PizzaSalad(MenuFrame manuFrame) {
		...
		pizzaButton.setIcon(new ImageIcon("./img/menu/pizza&salad1.png"));
		...
		menuFrameLable.setIcon(new ImageIcon("./img/menu/pizzaframe.png"));
