...
public class MenuPanel2Pasta extends JPanel {
	
	private MenuFrame mFrame;
	
	
	public MenuPanel2Pasta(MenuFrame manuFrame) {
		...
		pastButton.setIcon(new ImageIcon("./img/menu/pastabutton1.png"));
		...
		menuFrameLable.setIcon(new ImageIcon("./img/menu/pastaframe.png"));
