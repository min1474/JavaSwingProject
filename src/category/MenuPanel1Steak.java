...
public class MenuPanel1Steak extends JPanel {
	
	private MenuFrame mFrame;

	
	public MenuPanel1Steak(MenuFrame manuFrame) {
		...
		steakButton.setIcon(new ImageIcon("./img/menu/steak1.png"));
		...
		menuFrameLable.setIcon(new ImageIcon("./img/menu/steakframe.png"));
