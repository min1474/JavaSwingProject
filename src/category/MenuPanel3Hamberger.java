...
public class MenuPanel3Hamberger extends JPanel {
	
	private MenuFrame mFrame;
	
	
	public MenuPanel3Hamberger(MenuFrame manuFrame) {
		...
		hambergerButton.setIcon(new ImageIcon("./img/menu/hamberger1.png"));
		...
		menuFrameLable.setIcon(new ImageIcon("./img/menu/hambergerframe.png"));
