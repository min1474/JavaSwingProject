...
public class SearchBookingInfoNonMember extends JFrame{

//	// 기본 생성자
//	public SearchBookingInfoNonMember() {
//	}
	
	// 매개변수 BookingDTO가 있는 생성자 
	public SearchBookingInfoNonMember(BookingDTO dtoB) {
		...
		JLabel getLabel_tel = new JLabel(dtoB.getTableNum());
	...
	public void saveFile(BookingDTO dtoB) {		
		...
		ArrayList<BookingDTO> list = dao.saveFileInBookingPageNonMember(dtoB);
	...
	public void deleteBookingInfo(BookingDTO dtoB) {
		BookingDAO dao = new BookingDAO();
		dao.deleteInBookingInfoNonMember(dtoB);
